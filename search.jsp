...
<p>	    <h3>Search_Criteria::</h3>
	<select name="criteria" >
		<option value="name"><h4>Name</h4></option>
		<option value="workplace">Workplace/Organisation/Institution</option>
		<option value="city">Location</option>
		<option value="country">Country</option>
		<option value="research area/feild of work">Research Area/Feild Of Work</option>

	</select></p>
	    <input type="text" name="name" class="login-input" placeholder="Keyword" autofocus>
