...
<h3>Login As:</h3>
    ...
    <input type="text" name="username" class="login-input" placeholder="Username(Full_Name)" autofocus>
    <input type="password" name="password" class="login-input" placeholder="Password">
    <center> <input type="submit" value="Login" class="login-submit"> </center>
    <p class="login-help"><a href="#"> Forgot password? </a>|<a href="#"> SignUp as Student </a>|<a href="#"> SignUp as Alumni </a></p>
  </form>
</body>
</html>
